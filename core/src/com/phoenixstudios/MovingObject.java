...
public class MovingObject extends Actor{
    ...
    public MovingObject(boolean right, int y_pos, ControlledObject controlledObjectRight, ControlledObject controlledObjectLeft, TwoPlay game) {
        ...
        final MovingObject object_ref = this;
